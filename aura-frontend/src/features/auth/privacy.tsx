const PrivacyAndTerms = () => {
  return (
    <div style={{ padding: '40px', maxWidth: '900px', margin: '0 auto', lineHeight: '1.7', color: '#333', fontFamily: 'Arial, sans-serif' }}>
      <h1 style={{ borderBottom: '2px solid #000000', paddingBottom: '10px' }}>Chính sách quyền riêng tư và Điều khoản - AI Understanding Retinal Analysis (AURA)</h1>
      <p><em>Ngày cập nhật cuối cùng: 01 tháng 02 năm 2026</em></p>

      {/* 1. Chính sách quyền riêng tư */}
      <section style={{ backgroundColor: '#f8f9fa', padding: '20px', borderRadius: '8px', borderLeft: '5px solid #007bff' }}>
        <h2 style={{ color: '#000000' }}>1. Chính sách quyền riêng tư (Privacy Policy)</h2>
        <p>Ứng dụng <strong>AURA</strong> sử dụng tính năng Đăng nhập qua Facebook để tối ưu hóa trải nghiệm người dùng. Chúng tôi cam kết bảo vệ thông tin cá nhân của bạn theo các tiêu chuẩn sau:</p>
        <ul>
      ...
      <section style={{ backgroundColor: '#f8f9fa', padding: '20px', borderRadius: '8px', borderLeft: '5px solid #007bff' }}>
        <h2 style={{ color: '#000000' }}>2. Điều khoản dịch vụ (Terms of Service)</h2>
      ...
      <section style={{ backgroundColor: '#f8f9fa', padding: '20px', borderRadius: '8px', borderLeft: '5px solid #dc3545' }}>
        <h2 style={{ color: '#000000', marginTop: 0 }}>3. Hướng dẫn xóa dữ liệu (Data Deletion Instructions)</h2>
        ...
        <ol>
          ...
          <li>Chúng tôi sẽ tiến hành xóa toàn bộ dữ liệu liên quan của bạn khỏi cơ sở dữ liệu trong vòng 72 giờ làm việc và gửi phản hồi xác nhận.</li>
        </ol>
      </section>
